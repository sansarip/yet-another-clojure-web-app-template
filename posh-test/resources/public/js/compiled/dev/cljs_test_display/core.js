...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq34599){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34600,G__34601,seq34599__$2);
});
...
var vec__34605 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__34605,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__34605,(1),null);
var G__34608 = cljs.core.PersistentArrayMap.EMPTY;
var G__34608__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__34608,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__34608);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__34608__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__34608__$1;
}
} else {
...
return (function() { 
var G__34612__delegate = function (klass,contents){
var vec__34609 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__34609,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__34609,(1),null);
...
var G__34612 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__34613__i = 0, G__34613__a = new Array(arguments.length -  1);
while (G__34613__i < G__34613__a.length) {G__34613__a[G__34613__i] = arguments[G__34613__i + 1]; ++G__34613__i;}
  contents = new cljs.core.IndexedSeq(G__34613__a,0,null);
} 
return G__34612__delegate.call(this,klass,contents);};
G__34612.cljs$lang$maxFixedArity = 1;
G__34612.cljs$lang$applyTo = (function (arglist__34614){
var klass = cljs.core.first(arglist__34614);
var contents = cljs.core.rest(arglist__34614);
return G__34612__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__34618){
...
var ns = cljs.core.get.call(null,map__34619__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__34621){
...
var actual = cljs.core.get.call(null,map__34622__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__34622__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__34624){
...
var expected = cljs.core.get.call(null,map__34625__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__34625__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__34627_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__34629 = cljs_test_display.core.current_var_info.call(null);
...
var info = map__34629__$1;
var name = cljs.core.get.call(null,map__34629__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__34629__$1,new cljs.core.Keyword(null,"line","line",212345235));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__34629,map__34629__$1,info,name,line,file,node){
return (function (p1__34628_SHARP_){
return cljs.core.cons.call(null,node,p1__34628_SHARP_);
});})(curr_node,map__34629,map__34629__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__34631){
...
var fail = cljs.core.get.call(null,map__34632__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__34632__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__34632__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__34632__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5735__auto___34634 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___34634)){
var message_34635 = temp__5735__auto___34634;
cljs.core.println.call(null,message_34635);
} else {
}
...
var temp__5735__auto___34636 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___34636)){
var message_34637 = temp__5735__auto___34636;
cljs.core.println.call(null,message_34637);
} else {
}
