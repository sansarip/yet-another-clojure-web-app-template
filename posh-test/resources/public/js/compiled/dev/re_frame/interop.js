...
return [(function (){var pred__11785 = cljs.core.instance_QMARK_;
var expr__11786 = reactive_val;
if(cljs.core.truth_(pred__11785.call(null,reagent.ratom.RAtom,expr__11786))){
return "ra";
} else {
if(cljs.core.truth_(pred__11785.call(null,reagent.ratom.RCursor,expr__11786))){
return "rc";
} else {
if(cljs.core.truth_(pred__11785.call(null,reagent.ratom.Reaction,expr__11786))){
return "rx";
} else {
if(cljs.core.truth_(pred__11785.call(null,reagent.ratom.Track,expr__11786))){
return "tr";
} else {
return "other";
}
