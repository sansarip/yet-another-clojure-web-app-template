...
var G__13523 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__13523;
continue;
} else {
return ch;
...
var vec__13524 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__13524,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq13527){
...
return (function() { 
var G__13532__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__13532 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__13533__i = 0, G__13533__a = new Array(arguments.length -  1);
while (G__13533__i < G__13533__a.length) {G__13533__a[G__13533__i] = arguments[G__13533__i + 1]; ++G__13533__i;}
  _ = new cljs.core.IndexedSeq(G__13533__a,0,null);
} 
return G__13532__delegate.call(this,rdr,_);};
...
var _ = cljs.core.rest(arglist__13534);
return G__13532__delegate(rdr,_);
});
