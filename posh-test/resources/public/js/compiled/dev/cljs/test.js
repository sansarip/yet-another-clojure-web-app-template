...
var G__13249 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__13249,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__13249;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq13251){
var G__13252 = cljs.core.first.call(null,seq13251);
var seq13251__$1 = cljs.core.next.call(null,seq13251);
var G__13253 = cljs.core.first.call(null,seq13251__$1);
var seq13251__$2 = cljs.core.next.call(null,seq13251__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13252,G__13253,seq13251__$2);
});
...
var file = cljs.core.get.call(null,map__13258__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__13258__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__13258__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__13258,map__13258__$1,file,line,column){
return (function (p1__13257_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__13257_SHARP_));
});})(map__13258,map__13258__$1,file,line,column))
...
var temp__5735__auto___13260 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___13260)){
var message_13261 = temp__5735__auto___13260;
cljs.core.println.call(null,message_13261);
} else {
}
...
var temp__5735__auto___13262 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___13262)){
var message_13263 = temp__5735__auto___13262;
cljs.core.println.call(null,message_13263);
} else {
}
...
var output_dir__$1 = (function (){var G__13264 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__13264,"/"].join('');
} else {
return G__13264;
}
})();
...
var G__13266 = exception.stack;
var G__13266__$1 = (((G__13266 == null))?null:clojure.string.split_lines.call(null,G__13266));
var G__13266__$2 = (((G__13266__$1 == null))?null:cljs.core.get.call(null,G__13266__$1,depth));
if((G__13266__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__13266__$2);
}
} else {
...
var vec__13267 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__13267,(0),null);
var column = cljs.core.nth.call(null,vec__13267,(1),null);
var vec__13270 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__13270,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__13270,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__13270,(2),null);
...
var m__$1 = (function (){var G__13273 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__13277 = (function (){var G__13276 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__13276);
} else {
return G__13276;
}
})();
...
return cljs.core.vary_meta.call(null,G__13278,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__13282 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__13282,(0),null);
var types = vec__13282;
...
return cljs.core.map.call(null,(function (p__13285){
var vec__13286 = p__13285;
var ns = cljs.core.nth.call(null,vec__13286,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__13286,(1),null);
return ((function (vec__13286,ns,vars__$1){
return (function (){
...
var G__13289 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__13289__$1 = (((G__13289 instanceof cljs.core.Keyword))?G__13289.fqn:null);
switch (G__13289__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__13289,G__13289__$1,env,once_fixtures,each_fixtures,vec__13286,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__13289,G__13289__$1,env,once_fixtures,each_fixtures,vec__13286,ns,vars__$1){
return (function (){
var seq__13290 = cljs.core.seq.call(null,vars__$1);
var chunk__13291 = null;
var count__13292 = (0);
var i__13293 = (0);
while(true){
if((i__13293 < count__13292)){
var v = cljs.core._nth.call(null,chunk__13291,i__13293);
var temp__5735__auto___13295 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___13295)){
var t_13296 = temp__5735__auto___13295;
each_fixture_fn.call(null,((function (seq__13290,chunk__13291,count__13292,i__13293,t_13296,temp__5735__auto___13295,v,each_fixture_fn,G__13289,G__13289__$1,env,once_fixtures,each_fixtures,vec__13286,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13296)));
});})(seq__13290,chunk__13291,count__13292,i__13293,t_13296,temp__5735__auto___13295,v,each_fixture_fn,G__13289,G__13289__$1,env,once_fixtures,each_fixtures,vec__13286,ns,vars__$1))
);
} else {
}


var G__13297 = seq__13290;
var G__13298 = chunk__13291;
var G__13299 = count__13292;
var G__13300 = (i__13293 + (1));
seq__13290 = G__13297;
chunk__13291 = G__13298;
count__13292 = G__13299;
i__13293 = G__13300;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq.call(null,seq__13290);
if(temp__5735__auto__){
var seq__13290__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__13290__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__13290__$1);
var G__13301 = cljs.core.chunk_rest.call(null,seq__13290__$1);
var G__13302 = c__4550__auto__;
var G__13303 = cljs.core.count.call(null,c__4550__auto__);
var G__13304 = (0);
seq__13290 = G__13301;
chunk__13291 = G__13302;
count__13292 = G__13303;
i__13293 = G__13304;
continue;
} else {
var v = cljs.core.first.call(null,seq__13290__$1);
var temp__5735__auto___13305__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___13305__$1)){
var t_13306 = temp__5735__auto___13305__$1;
each_fixture_fn.call(null,((function (seq__13290,chunk__13291,count__13292,i__13293,t_13306,temp__5735__auto___13305__$1,v,seq__13290__$1,temp__5735__auto__,each_fixture_fn,G__13289,G__13289__$1,env,once_fixtures,each_fixtures,vec__13286,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13306)));
});})(seq__13290,chunk__13291,count__13292,i__13293,t_13306,temp__5735__auto___13305__$1,v,seq__13290__$1,temp__5735__auto__,each_fixture_fn,G__13289,G__13289__$1,env,once_fixtures,each_fixtures,vec__13286,ns,vars__$1))
);
} else {
}


var G__13307 = cljs.core.next.call(null,seq__13290__$1);
var G__13308 = null;
var G__13309 = (0);
var G__13310 = (0);
seq__13290 = G__13307;
...
});})(each_fixture_fn,G__13289,G__13289__$1,env,once_fixtures,each_fixtures,vec__13286,ns,vars__$1))
);
});})(each_fixture_fn,G__13289,G__13289__$1,env,once_fixtures,each_fixtures,vec__13286,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13289__$1)].join('')));

}
})());
});
;})(vec__13286,ns,vars__$1))
