...
return cljs.core.filter.call(null,(function (p1__38250_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__38250_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__38250_SHARP_) <= ending)));
}));
});
...
var G__38251 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
return cljs.core._EQ_.call(null,new cljs.core.Keyword("sub","dispose","sub/dispose",365440536),p1__38253_SHARP_);
});})(and__4120__auto__))
...
return cljs.core.assoc_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"operation","operation",-1267664310).cljs$core$IFn$_invoke$arity$1(trace),new cljs.core.Keyword(null,"layer","layer",-1601820589)], null),(cljs.core.truth_(cljs.core.some.call(null,(function (p1__38254_SHARP_){
return cljs.core._EQ_.call(null,app_db_id,p1__38254_SHARP_);
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,(function (me__$1){
if(cljs.core.truth_(new cljs.core.Keyword(null,"disposed?","disposed?",1178302522).cljs$core$IFn$_invoke$arity$1(cljs.core.val.call(null,me__$1)))){
return null;
} else {
return me__$1;
}
})),cljs.core.map.call(null,(function (p__38255){
var vec__38256 = p__38255;
var k = cljs.core.nth.call(null,vec__38256,(0),null);
var v = cljs.core.nth.call(null,vec__38256,(1),null);
...
var new_state = (function (){var G__38259 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
break;
case "sub/run":
return cljs.core.update.call(null,state,reaction_id,((function (G__38259,G__38259__$1,tags,reaction_id,state){
...
});})(G__38259,G__38259__$1,tags,reaction_id,state))
);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38259__$1)].join('')));
...
return (function (all_state,p__38260){
var vec__38261 = p__38260;
var sub_id = cljs.core.nth.call(null,vec__38261,(0),null);
var sub_state = cljs.core.nth.call(null,vec__38261,(1),null);
