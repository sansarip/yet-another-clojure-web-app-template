...
if((i < len)){
var k = (ks[i]);
var G__38585 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__38586 = (i + (1));
m = G__38585;
i = G__38586;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__38588 = c;
var G__38588__$1 = (((G__38588 == null))?null:G__38588.prototype);
if((G__38588__$1 == null)){
return null;
} else {
return (G__38588__$1["reagentRender"]);
}
})() == null)))));
});
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__38590 = c;
var G__38590__$1 = (((G__38590 == null))?null:G__38590.prototype);
if((G__38590__$1 == null)){
return null;
} else {
return (G__38590__$1["render"]);
}
})() == null)))));
});
...
while (G__38594__i < G__38594__a.length) {G__38594__a[G__38594__i] = arguments[G__38594__i + 0]; ++G__38594__i;}
  args = new cljs.core.IndexedSeq(G__38594__a,0,null);
} 
...
var args = cljs.core.seq(arglist__38595);
...
var _STAR_current_component_STAR__orig_val__38597 = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38598 = c;
day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38598;
...
}finally {day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38597;
}});
...
var G__38599 = key;
var G__38599__$1 = (((G__38599 instanceof cljs.core.Keyword))?G__38599.fqn:null);
switch (G__38599__$1) {
...
return ((function (G__38599,G__38599__$1){
...
var c = this;
var G__38600_38602 = (c["cljsRatom"]);
if((G__38600_38602 == null)){
} else {
day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.ratom.dispose_BANG_.call(null,G__38600_38602);
}
...
var renders_38604 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_38605 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_38604));
if((cljs.core.count.call(null,renders_38604) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_38604))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_38605)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_38605)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__38603 = name;
switch (G__38603) {
case "":
...
var G__38607 = o;
(G__38607[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__38608 = fiber;
var G__38608__$1 = (((G__38608 == null))?null:(G__38608["type"]));
if((G__38608__$1 == null)){
return null;
} else {
return (G__38608__$1["displayName"]);
}
})();
var parent = (function (){var G__38609 = fiber;
if((G__38609 == null)){
return null;
} else {
return (G__38609["return"]);
}
})();
var path = (function (){var G__38610 = parent;
var G__38610__$1 = (((G__38610 == null))?null:day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component.fiber_component_path.call(null,G__38610));
if((G__38610__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38610__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4131__auto__ = (function (){var G__38612 = c;
if((G__38612 == null)){
return null;
} else {
return (G__38612["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__38613._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__38615 = c;
if((G__38615 == null)){
return null;
} else {
return (G__38615["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__38617 = c;
if((G__38617 == null)){
return null;
} else {
return G__38617._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__38619 = instance;
if((G__38619 == null)){
return null;
} else {
return (G__38619["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__38620 = instance;
if((G__38620 == null)){
return null;
} else {
return G__38620._currentElement;
}
}
})();
var name = (function (){var G__38621 = elem;
var G__38621__$1 = (((G__38621 == null))?null:(G__38621["type"]));
if((G__38621__$1 == null)){
return null;
} else {
return (G__38621__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__38623 = elem;
if((G__38623 == null)){
return null;
} else {
return (G__38623["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__38624._owner;
}
}
})();
var path = (function (){var G__38625 = owner;
var G__38625__$1 = (((G__38625 == null))?null:day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component.component_path.call(null,G__38625));
if((G__38625__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38625__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__38626 = c;
var G__38626__$1 = (((G__38626 == null))?null:G__38626.constructor);
if((G__38626__$1 == null)){
return null;
} else {
return day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.util.fun_name.call(null,G__38626__$1);
}
}
})();
