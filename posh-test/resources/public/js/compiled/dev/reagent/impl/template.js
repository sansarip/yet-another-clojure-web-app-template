...
var G__11611 = o;
goog.object.set(G__11611,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__11613__i < G__11613__a.length) {G__11613__a[G__11613__i] = arguments[G__11613__i + 0]; ++G__11613__i;}
  args = new cljs.core.IndexedSeq(G__11613__a,0,null);
} 
...
var G__11615 = o;
goog.object.set(G__11615,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__11616__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__11616 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__11617__i = 0, G__11617__a = new Array(arguments.length -  0);
while (G__11617__i < G__11617__a.length) {G__11617__a[G__11617__i] = arguments[G__11617__i + 0]; ++G__11617__i;}
  args = new cljs.core.IndexedSeq(G__11617__a,0,null);
} 
return G__11616__delegate.call(this,args);};
G__11616.cljs$lang$maxFixedArity = 0;
G__11616.cljs$lang$applyTo = (function (arglist__11618){
var args = cljs.core.seq(arglist__11618);
return G__11616__delegate(args);
});
...
var G__11619 = props;
var G__11619__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__11619,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11619);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__11619__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__11619__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__11620 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__11620,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__11620;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__11621){
...
var on_write = cljs.core.get.call(null,map__11622__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__11622,map__11622__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__11622,map__11622__$1,on_write))
);
} else {
...
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__11624_SHARP_);
});})(v,value,on_change))
;
} else {
return null;
...
var vec__11627 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__11627,(0),null);
var id = cljs.core.nth.call(null,vec__11627,(1),null);
var className = cljs.core.nth.call(null,vec__11627,(2),null);
...
var temp__5739__auto___11631 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___11631 == null)){
} else {
var key_11632 = temp__5739__auto___11631;
jsprops.key = key_11632;
}
...
var temp__5739__auto___11633 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___11633 == null)){
} else {
var key_11634 = temp__5739__auto___11633;
jsprops.key = key_11634;
}
...
var temp__5739__auto___11635 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___11635 == null)){
} else {
var key_11636 = temp__5739__auto___11635;
jsprops.key = key_11636;
}
...
var G__11638 = n;
if(cljs.core._EQ_.call(null,"",G__11638)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__11638)){
return x;
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq11639){
var G__11640 = cljs.core.first.call(null,seq11639);
var seq11639__$1 = cljs.core.next.call(null,seq11639);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11640,seq11639__$1);
});
...
break;
default:
var G__11646 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__11646;
continue;
...
var ctx = ({});
var vec__11648 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__11648,(0),null);
var derefed = cljs.core.nth.call(null,vec__11648,(1),null);
...
var G__11651 = (cljs.core.count.call(null,argv) - first_child);
switch (G__11651) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__11651){
