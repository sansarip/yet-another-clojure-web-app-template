...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__37450_SHARP_){
if(cljs.core.not_EQ_.call(null,p1__37450_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__37450_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__37451){
var vec__37452 = p__37451;
var low = cljs.core.nth.call(null,vec__37452,(0),null);
var high = cljs.core.nth.call(null,vec__37452,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__37455,s,color,element,idx){
...
var style_map = cljs.core.get.call(null,map__37456__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.call(null,map__37456__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.call(null,map__37456__$1,new cljs.core.Keyword(null,"select","select",1147833503));
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__37458){
var vec__37459 = p__37458;
var s = cljs.core.nth.call(null,vec__37459,(0),null);
var style = cljs.core.nth.call(null,vec__37459,(1),null);
var start = cljs.core.nth.call(null,vec__37459,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__37462){
var vec__37463 = p__37462;
var s = cljs.core.nth.call(null,vec__37463,(0),null);
var keyword_color = cljs.core.nth.call(null,vec__37463,(1),null);
var element = cljs.core.nth.call(null,vec__37463,(2),null);
...
var G__37466 = cljs.core.next.call(null,ssv);
var G__37467 = (this_ssv == null);
var G__37468 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__37469 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.call(null,cljs.core.conj.call(null,cljs.core.conj.call(null,out,zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.call(null,out,this_ssv)
)));
ssv = G__37466;
doing_nil_QMARK_ = G__37467;
last_elide = G__37468;
out = G__37469;
continue;
}
...
var vec__37473 = cljs.core.first.call(null,remaining_cvec);
var _ = cljs.core.nth.call(null,vec__37473,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__37473,(1),null);
var element_type = cljs.core.nth.call(null,vec__37473,(2),null);
...
var G__37476 = cljs.core.next.call(null,remaining_cvec);
var G__37477 = new_idx;
var G__37478 = cljs.core.conj.call(null,out,new_idx);
remaining_cvec = G__37476;
idx = G__37477;
out = G__37478;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__37489,cursor_vec){
var vec__37490 = p__37489;
var focus_start = cljs.core.nth.call(null,vec__37490,(0),null);
var focus_end = cljs.core.nth.call(null,vec__37490,(1),null);
var focus_vec = vec__37490;
...
var vec__37493 = cljs.core.split_at.call(null,focus_start,gcw_vec);
var front = cljs.core.nth.call(null,vec__37493,(0),null);
var back = cljs.core.nth.call(null,vec__37493,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__37496){
var vec__37497 = p__37496;
var s = cljs.core.nth.call(null,vec__37497,(0),null);
var color = cljs.core.nth.call(null,vec__37497,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__37503,existing_count){
var vec__37504 = p__37503;
var s = cljs.core.nth.call(null,vec__37504,(0),null);
var cursor = cljs.core.nth.call(null,vec__37504,(1),null);
...
return cljs.core.filterv.call(null,((function (s__$1,len,cursor__$1,vec__37504,s,cursor){
return (function (p1__37500_SHARP_){
return (!(cljs.core.empty_QMARK_.call(null,cljs.core.first.call(null,p1__37500_SHARP_))));
});})(s__$1,len,cursor__$1,vec__37504,s,cursor))
...
var vec__37511 = cljs.core.first.call(null,cvec_nl);
var n = cljs.core.nth.call(null,vec__37511,(0),null);
var where = cljs.core.nth.call(null,vec__37511,(1),null);
var cvec_element = vec__37511;
if((cvec_element == null)){
var G__37514 = cljs.core.next.call(null,cvec_nl);
var G__37515 = (idx + (1));
var G__37516 = start;
var G__37517 = out;
cvec_nl = G__37514;
...
var G__37518 = cljs.core.next.call(null,cvec_nl);
var G__37519 = (idx + (1));
var G__37520 = idx;
var G__37521 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__37518;
idx = G__37519;
start = G__37520;
out = G__37521;
...
var G__37522 = cljs.core.next.call(null,cvec_nl);
var G__37523 = (idx + (1));
var G__37524 = (idx + (1));
var G__37525 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__37522;
idx = G__37523;
start = G__37524;
out = G__37525;
...
var G__37526 = cljs.core.next.call(null,cvec_nl);
var G__37527 = (idx + (1));
var G__37528 = idx;
var G__37529 = cljs.core.apply.call(null,cljs.core.conj,cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__37526;
idx = G__37527;
start = G__37528;
out = G__37529;
...
var G__37530 = cljs.core.next.call(null,cvec_nl);
var G__37531 = (idx + (1));
var G__37532 = start;
var G__37533 = cljs.core.apply.call(null,cljs.core.conj,out,cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__37530;
idx = G__37531;
start = G__37532;
out = G__37533;
...
return cljs.core.reduce.call(null,(function (p1__37535_SHARP_,p2__37534_SHARP_){
if(zprint.finish.within_QMARK_.call(null,idx,p2__37534_SHARP_)){
return cljs.core.reduced.call(null,p1__37535_SHARP_);
} else {
return (p1__37535_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__37536,p__37537){
var vec__37538 = p__37536;
var focus_begin = cljs.core.nth.call(null,vec__37538,(0),null);
var focus_end = cljs.core.nth.call(null,vec__37538,(1),null);
var vec__37541 = p__37537;
var before = cljs.core.nth.call(null,vec__37541,(0),null);
var after = cljs.core.nth.call(null,vec__37541,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__37545,cvec,focus_vec){
...
var options = map__37546__$1;
var map__37547 = cljs.core.get.call(null,map__37546__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.call(null,map__37547__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.call(null,map__37547__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.call(null,map__37547__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.call(null,((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__37546,map__37546__$1,options,map__37547,map__37547__$1,focus,lines,paths){
return (function (p1__37544_SHARP_){
return zprint.finish.surround_focus.call(null,lines_to_cvec,p1__37544_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__37546,map__37546__$1,options,map__37547,map__37547__$1,focus,lines,paths))
,path_vecs);
