...
var G__37296 = rewrite_clj.zip.next.call(null,n);
loc = G__37296;
continue;
} else {
var G__37297 = rewrite_clj.zip.next.call(null,loc);
loc = G__37297;
continue;
}
} else {
var G__37298 = rewrite_clj.zip.next.call(null,loc);
loc = G__37298;
continue;
}
}
...
return rewrite_clj.zip.replace.call(null,zloc,rewrite_clj.zip.root.call(null,zprint.rewrite.prewalk_subtree.call(null,p_QMARK_,f,(function (){var G__37299 = zloc;
var G__37299__$1 = (((G__37299 == null))?null:rewrite_clj.zip.node.call(null,G__37299));
if((G__37299__$1 == null)){
return null;
} else {
return zprint.zutil.edn_STAR_.call(null,G__37299__$1);
}
})())));
});
/**
...
var G__37300 = rewrite_clj.zip.down.call(null,nloc);
nloc = G__37300;
continue;
}
break;
...
var G__37301 = rewrite_clj.zip.right.call(null,nloc);
var G__37302 = cljs.core.conj.call(null,out,nloc);
nloc = G__37301;
out = G__37302;
continue;
} else {
...
var G__37303 = rewrite_clj.zip.right.call(null,replaced_loc);
var G__37304 = cljs.core.next.call(null,new_loc);
var G__37305 = replaced_loc;
nloc = G__37303;
new_loc = G__37304;
last_loc = G__37305;
continue;
...
var new_dep = zprint.rewrite.prewalk.call(null,zloc,(function (p1__37306_SHARP_){
return ((cljs.core._EQ_.call(null,rewrite_clj.zip.tag.call(null,p1__37306_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.call(null,rewrite_clj.zip.sexpr.call(null,p1__37306_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
