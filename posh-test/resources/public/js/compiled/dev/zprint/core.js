...
var vec__38178 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper.call(null,options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__38181 = zprint.zutil.find_root_and_path_nw.call(null,coll);
var root = cljs.core.nth.call(null,vec__38181,(0),null);
var path = cljs.core.nth.call(null,vec__38181,(1),null);
...
var input = cljs.core.nth.call(null,vec__38178,(0),null);
var options__$1 = cljs.core.nth.call(null,vec__38178,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__38184){
var vec__38185 = p__38184;
var width_or_options = cljs.core.nth.call(null,vec__38185,(0),null);
var options = cljs.core.nth.call(null,vec__38185,(1),null);
...
var vec__38191 = zprint.config.perform_remove.call(null,null,null,zprint.config.get_options.call(null),rest_options);
var internal_map = cljs.core.nth.call(null,vec__38191,(0),null);
var rest_options__$1 = cljs.core.nth.call(null,vec__38191,(1),null);
var _ = cljs.core.nth.call(null,vec__38191,(2),null);
var vec__38194 = zprint.config.apply_style.call(null,null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.call(null,vec__38194,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__38194,(1),null);
var style_errors = cljs.core.nth.call(null,vec__38194,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__38199){
var vec__38200 = p__38199;
var start = cljs.core.nth.call(null,vec__38200,(0),null);
var end = cljs.core.nth.call(null,vec__38200,(1),null);
...
var vec__38206 = zprint.core.process_rest_options.call(null,internal_options,rest);
var special_option = cljs.core.nth.call(null,vec__38206,(0),null);
var rest_options = cljs.core.nth.call(null,vec__38206,(1),null);
...
var vec__38209 = zprint.core.zprint_STAR_.call(null,coll,special_option,actual_options);
var cvec = cljs.core.nth.call(null,vec__38209,(0),null);
var options = cljs.core.nth.call(null,vec__38209,(1),null);
...
/** @this {Function} */
zprint.core.czprint_str_internal.cljs$lang$applyTo = (function (seq38203){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38204,G__38205,seq38203__$2);
});
...
var args__4736__auto__ = [];
var len__4730__auto___38219 = arguments.length;
var i__4731__auto___38220 = (0);
while(true){
if((i__4731__auto___38220 < len__4730__auto___38219)){
args__4736__auto__.push((arguments[i__4731__auto___38220]));

var G__38221 = (i__4731__auto___38220 + (1));
i__4731__auto___38220 = G__38221;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.zprint_str.cljs$lang$applyTo = (function (seq38217){
var G__38218 = cljs.core.first.call(null,seq38217);
var seq38217__$1 = cljs.core.next.call(null,seq38217);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38218,seq38217__$1);
});
...
/** @this {Function} */
zprint.core.czprint_str.cljs$lang$applyTo = (function (seq38222){
var G__38223 = cljs.core.first.call(null,seq38222);
var seq38222__$1 = cljs.core.next.call(null,seq38222);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38223,seq38222__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___38229 = arguments.length;
var i__4731__auto___38230 = (0);
while(true){
if((i__4731__auto___38230 < len__4730__auto___38229)){
args__4736__auto__.push((arguments[i__4731__auto___38230]));

var G__38231 = (i__4731__auto___38230 + (1));
i__4731__auto___38230 = G__38231;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.zprint.cljs$lang$applyTo = (function (seq38227){
var G__38228 = cljs.core.first.call(null,seq38227);
var seq38227__$1 = cljs.core.next.call(null,seq38227);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38228,seq38227__$1);
});
...
/** @this {Function} */
zprint.core.czprint.cljs$lang$applyTo = (function (seq38232){
var G__38233 = cljs.core.first.call(null,seq38232);
var seq38232__$1 = cljs.core.next.call(null,seq38232);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38233,seq38232__$1);
});
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__38238,form){
var vec__38239 = p__38238;
var next_options = cljs.core.nth.call(null,vec__38239,(0),null);
var _ = cljs.core.nth.call(null,vec__38239,(1),null);
var indent = cljs.core.nth.call(null,vec__38239,(2),null);
var zprint_num = cljs.core.nth.call(null,vec__38239,(3),null);
...
var vec__38242 = (cljs.core.truth_((function (){var and__4120__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4120__auto__)){
...
var new_options = cljs.core.nth.call(null,vec__38242,(0),null);
var error_str = cljs.core.nth.call(null,vec__38242,(1),null);
