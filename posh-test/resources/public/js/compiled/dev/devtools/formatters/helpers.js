...
var G__35940 = devtools.prefs.pref.call(null,v);
v = G__35940;
continue;
} else {
return v;
...
}catch (e35943){var _e__34952__auto__ = e35943;
return false;
}})();
...
}catch (e35947){var _e__34952__auto__ = e35947;
return false;
}})();
...
}catch (e35949){var _e__34952__auto__ = e35949;
return false;
}}
}
});
...
var vec__35951 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__35951,(0),null);
var name = cljs.core.nth.call(null,vec__35951,(1),null);
...
return cljs.core.some.call(null,(function (p1__35954_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__35954_SHARP_);
}),template);
});
