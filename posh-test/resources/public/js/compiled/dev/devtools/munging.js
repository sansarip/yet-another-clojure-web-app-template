...
var o35835 = temp__5733__auto__;
var temp__5733__auto____$1 = (o35835["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o35836 = temp__5733__auto____$1;
return (o35836["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__34945__auto__ = f;
return (o__34945__auto__["toString"]).call(o__34945__auto__);
} else {
return "";
}
}catch (e35837){var _ = e35837;
return "";
}});
...
try{var o__34945__auto___35839 = t;
(o__34945__auto___35839["cljs$lang$ctorPrWriter"]).call(o__34945__auto___35839,t,writer);
}catch (e35838){var __35840 = e35838;
}
...
var char_code = (function (){var o__34945__auto__ = (new String(char$));
return (o__34945__auto__["charCodeAt"]).call(o__34945__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__34945__auto__ = String;
return (o__34945__auto__["fromCharCode"]).call(o__34945__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__35841 = num_code;
switch (G__35841) {
case (1):
return (185);
...
var o__34945__auto__ = String;
return (o__34945__auto__["fromCharCode"]).call(o__34945__auto__,superscript_code);
});
/**
...
}catch (e35843){var _e__34952__auto__ = e35843;
return false;
}})())){
...
var vec__35844 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__35844,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o35847 = temp__5733__auto__;
var temp__5733__auto____$1 = (o35847["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o35848 = temp__5733__auto____$1;
return (o35848["nameToPath"]);
} else {
return null;
}
} else {
...
args__4736__auto__.push((arguments[i__4731__auto___35856]));
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__35851){
var vec__35852 = p__35851;
var ns_detector = cljs.core.nth.call(null,vec__35852,(0),null);
...
var G__35858 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__35859 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__35858;
remaining_tokens = G__35859;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq35849){
var G__35850 = cljs.core.first.call(null,seq35849);
var seq35849__$1 = cljs.core.next.call(null,seq35849);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35850,seq35849__$1);
});
...
var vec__35863 = cljs.core.split_with.call(null,(function (p1__35862_SHARP_){
return cljs.core.not_EQ_.call(null,p1__35862_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__35863,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__35863,(1),null);
...
var vec__35869 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__35869,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__35869,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__35872 = cljs.core.rest.call(null,remaining_tokens);
var G__35873 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__35872;
name_tokens = G__35873;
continue;
} else {
...
var vec__35876 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__35876,(0),null);
var arity = cljs.core.nth.call(null,vec__35876,(1),null);
var vec__35879 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__35879,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__35879,(1),null);
var vec__35882 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__35882,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__35882,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__35882,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__35882,(3),null);
...
var vec__35888 = result;
var munged_ns = cljs.core.nth.call(null,vec__35888,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__35888,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__35888,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__35888,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__35888,(4),null);
var arity = cljs.core.nth.call(null,vec__35888,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__35892 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__35892,(0),null);
var args = cljs.core.nth.call(null,vec__35892,(1),null);
var vec__35895 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__35895,(0),null);
var name = cljs.core.nth.call(null,vec__35895,(1),null);
...
var G__35898 = (arity + (1));
var G__35899 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__35900){
var vec__35901 = p__35900;
var arity = cljs.core.nth.call(null,vec__35901,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__35901,(1),null);
...
return cljs.core.get.call(null,arities,p1__35904_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__35905_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__35908){
var vec__35909 = p__35908;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__35909,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq35906){
var G__35907 = cljs.core.first.call(null,seq35906);
var seq35906__$1 = cljs.core.next.call(null,seq35906);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35907,seq35906__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__35917__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__35917__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__35917__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__35917__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__35918 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__35918,(0),null);
var fn_name = cljs.core.nth.call(null,vec__35918,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__35918,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__35918,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__35918,(4),null);
var arity = cljs.core.nth.call(null,vec__35918,(5),null);
...
var o__34945__auto__ = f;
return (o__34945__auto__["getBasis"]).call(o__34945__auto__);
});
/**
...
}catch (e35922){var _e__34952__auto__ = e35922;
...
var G__35923 = (obj[cljs.core.first.call(null,path)]);
var G__35924 = cljs.core.rest.call(null,path);
obj = G__35923;
path = G__35924;
continue;
} else {
...
return (function (accum,p__35925){
var vec__35926 = p__35925;
var bit = cljs.core.nth.call(null,vec__35926,(0),null);
var protocol = cljs.core.nth.call(null,vec__35926,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__35929){
var vec__35930 = p__35929;
var ns = cljs.core.nth.call(null,vec__35930,(0),null);
var name = cljs.core.nth.call(null,vec__35930,(1),null);
var selector = cljs.core.nth.call(null,vec__35930,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__35935,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__35935,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__35935,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__35933_SHARP_){
return (obj[cljs.core.first.call(null,p1__35933_SHARP_)]);
});})(name,sorted_matches,vec__35935,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
